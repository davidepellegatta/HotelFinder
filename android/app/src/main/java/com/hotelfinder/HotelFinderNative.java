...
public class HotelFinderNative extends ReactContextBaseJavaModule {
    ...
    private void search(String description, String location, Callback errorCallback, Callback successCallback) {
        ...
        Expression locationExp = Function.lower(Expression.property("country"))
            .like(Expression.string("%" + location + "%"))
            .or(Function.lower(Expression.property("city")).like(Expression.string("%" + location + "%")))
            .or(Function.lower(Expression.property("state")).like(Expression.string("%" + location + "%")))
            .or(Function.lower(Expression.property("address")).like(Expression.string("%" + location + "%")));
